...
def _openai_manifest() -> dict[str, Any]:
    return {
        ...
        "interface": {
            ...
            "defaultPrompt": [
                "Plan an authorized, falsifiable Microsoft Sentinel threat hunt and identify its telemetry prerequisites.",
                "Author and offline-validate surface-specific KQL for an authorized defensive investigation.",
                "Stress-test a Sentinel hunt with synthetic fixtures, perturbations, mutations, and skeptical review.",
            ],
            "developerName": "Sentinel Hunt Workbench contributors",
            "displayName": "Sentinel Hunt Workbench",
            "longDescription": (
                "Build, adapt, test, and skeptically review authorized defensive "
                "Microsoft Sentinel and Defender hunts with typed parameters, "
                "versioned surface profiles, synthetic fixtures, and deterministic "
                "offline qualification evidence. The plugin has no live tenant "
                "connector and does not claim production validation."
            ),
            "shortDescription": "Offline Sentinel KQL hunt engineering",
        },
...
def _expected_files() -> tuple[dict[str, bytes], str]:
    ...
    files: dict[str, bytes] = {
        ...
        "openai/agents/sentinel-hunt-workbench.md": _router_body(
            "ChatGPT and Codex", bundle_hash
        ),
